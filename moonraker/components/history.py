...
class History:
    ...
    def _on_job_requested(self, user: UserInfo | None) -> None:
    ...
    def _accumulate_total(self, field: str, val: int | float) -> None:
        self.job_totals[field] += val

    def _maximize_total(self, field: str, val: int | float) -> None:
